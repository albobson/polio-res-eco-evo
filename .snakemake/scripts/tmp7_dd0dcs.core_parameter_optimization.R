...
snakemake <- Snakemake(
    ...
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'disk_mb', 'disk_mib', 'tmpdir', 'log_loc', 'mfree', 'cluster_time', 'disk_free', 'runtime', 'n_cores', "mem_mb" = '3G', "disk_mb" = 1000, "disk_mib" = 954, "tmpdir" = '/tmp/12722223.1.feder-short.q', "log_loc" = './log_scr/', "mfree" = '3G', "cluster_time" = '0:02:00:00', "disk_free" = '4G', "runtime" = 120, "n_cores" = '7'),
    config = list(),
    rule = 'opt_model',
