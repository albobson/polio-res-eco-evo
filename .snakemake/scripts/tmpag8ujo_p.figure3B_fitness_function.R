...
snakemake <- Snakemake(
    ...
    output = list('runs/ddt_logistic_mu_2e-05_2025-03-18/fig3/B.rds', 'runs/ddt_logistic_mu_2e-05_2025-03-18/dat_gen/params/fitness_function.csv'),
    params = list('2025-03-18', c('logistic'), c(2e-05), "date" = '2025-03-18', "fit_func" = c('logistic'), "mu" = c(2e-05)),
    wildcards = list(),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'disk_mb', 'tmpdir', 'log_loc', 'mfree', 'cluster_time', 'disk_free', 'runtime', 'n_cores', "mem_mb" = '3G', "disk_mb" = '4G', "tmpdir" = '/tmp/12559868.1.feder-short.q', "log_loc" = './log_scr/', "mfree" = '3G', "cluster_time" = '0:00:10:00', "disk_free" = '4G', "runtime" = 10, "n_cores" = '1'),
    config = list(),
    rule = 'fig3B',
