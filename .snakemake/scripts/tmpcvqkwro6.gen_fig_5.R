...
snakemake <- Snakemake(
    ...
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'disk_mb', 'tmpdir', 'log_loc', 'mfree', 'cluster_time', 'disk_free', 'runtime', 'n_cores', "mem_mb" = '3G', "disk_mb" = '4G', "tmpdir" = '/tmp/12724633.1.feder-short.q', "log_loc" = './log_scr/', "mfree" = '3G', "cluster_time" = '0:00:10:00', "disk_free" = '4G', "runtime" = 10, "n_cores" = '1'),
    config = list(),
    rule = 'gen_fig5',
...
ggsave(paste0(filepath, "res/fig5/fig5.png"), fig4, h = 22*(2/3), w = 18, unit = "cm", bg = "transparent", dpi = 300)
ggsave(paste0(filepath, "res/fig5/fig5.pdf"), fig4, h = 22*(2/3), w = 18, unit = "cm", bg = "transparent", dpi = 300)
ggsave(paste0(filepath, "res/fig5/fig5.svg"), fig4, h = 22*(2/3), w = 18, unit = "cm", bg = "transparent", dpi = 300, device = "svg")
