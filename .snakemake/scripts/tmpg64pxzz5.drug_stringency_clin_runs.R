...
snakemake <- Snakemake(
    ...
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'disk_mb', 'tmpdir', 'log_loc', 'mfree', 'cluster_time', 'disk_free', 'runtime', 'n_cores', "mem_mb" = '3G', "disk_mb" = '4G', "tmpdir" = '/tmp/12722605.1.feder-short.q', "log_loc" = './log_scr/', "mfree" = '3G', "cluster_time" = '3:00:00:00', "disk_free" = '4G', "runtime" = 4320, "n_cores" = '20'),
    config = list(),
