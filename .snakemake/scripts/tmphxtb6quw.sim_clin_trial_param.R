...
snakemake <- Snakemake(
    ...
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'disk_mb', 'tmpdir', 'log_loc', 'mfree', 'cluster_time', 'disk_free', 'runtime', 'n_cores', "mem_mb" = '3G', "disk_mb" = '4G', "tmpdir" = '/tmp/12560342.1.feder-short.q', "log_loc" = './log_scr/', "mfree" = '3G', "cluster_time" = '4:00:00:00', "disk_free" = '4G', "runtime" = 5760, "n_cores" = '20-25'),
    config = list(),
...
fit_func <- read.csv(paste0(filepath, "dat_gen/params/fitness_function.csv"))
