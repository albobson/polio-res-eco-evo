...
snakemake <- Snakemake(
    ...
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'disk_mb', 'tmpdir', 'log_loc', 'mfree', 'cluster_time', 'disk_free', 'runtime', 'n_cores', "mem_mb" = '3G', "disk_mb" = '4G', "tmpdir" = '/tmp/12679861.1.feder-short.q', "log_loc" = './log_scr/', "mfree" = '3G', "cluster_time" = '0:00:10:00', "disk_free" = '4G', "runtime" = 10, "n_cores" = '1'),
    config = list(),
    rule = 'fig6CDE',
...
ggsave(plot6c, file = paste0(filepath, "res/fig6/C.png"), h = 8, w = 8, bg = "transparent")
ggsave(plot6c, file = paste0(filepath, "res/fig6/C.jpg"), h = 8, w = 8, bg = "transparent")
ggsave(plot6c, file = paste0(filepath, "res/fig6/C.svg"), h = 8, w = 8, bg = "transparent", device = 'svg')
...
ggsave(plot6e, file = paste0(filepath, "res/fig6/E.png"), h = 8, w = 8, bg = "transparent")
ggsave(plot6e, file = paste0(filepath, "res/fig6/E.jpg"), h = 8, w = 8, bg = "transparent")
ggsave(plot6e, file = paste0(filepath, "res/fig6/E.svg"), h = 8, w = 8, bg = "transparent", device = 'svg')
