...
snakemake <- Snakemake(
    ...
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'disk_mb', 'tmpdir', 'log_loc', 'mfree', 'cluster_time', 'disk_free', 'runtime', 'n_cores', "mem_mb" = '3G', "disk_mb" = '4G', "tmpdir" = '/tmp/12680010.1.feder-short.q', "log_loc" = './log_scr/', "mfree" = '3G', "cluster_time" = '0:00:10:00', "disk_free" = '4G', "runtime" = 10, "n_cores" = '1'),
    config = list(),
    rule = 'fig5B',
...
## Save
ggsave(late_sim_p, file = paste0(filepath, "res/fig5/B.png"), bg = "transparent")
ggsave(late_sim_p, file = paste0(filepath, "res/fig5/B.jpg"), bg = "transparent")
ggsave(late_sim_p, file = paste0(filepath, "res/fig5/B.svg"), bg = "transparent", device = 'svg')
saveRDS(late_sim_p, paste0(filepath, "res/fig5/B.rds"))
