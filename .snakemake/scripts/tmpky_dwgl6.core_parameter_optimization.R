...
snakemake <- Snakemake(
    input = list('runs/ddt_logistic_mu_2e-05_2025-03-18/dat_gen/params/logistic_fitness_function.csv'),
    output = list('runs/ddt_logistic_mu_2e-05_2025-03-18/dat_gen/params/optim_params.csv'),
    params = list('2025-03-18', c('logistic'), c(2e-05), "date" = '2025-03-18', "fit_func" = c('logistic'), "mu" = c(2e-05)),
    wildcards = list(),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'disk_mb', 'disk_mib', 'tmpdir', 'log_loc', 'mfree', 'cluster_time', 'disk_free', 'runtime', 'n_cores', "mem_mb" = '3G', "disk_mb" = 1000, "disk_mib" = 954, "tmpdir" = '/tmp/12560306.1.feder-short.q', "log_loc" = './log_scr/', "mfree" = '3G', "cluster_time" = '0:02:00:00', "disk_free" = '4G', "runtime" = 120, "n_cores" = '7'),
    config = list(),
    rule = 'opt_model',
