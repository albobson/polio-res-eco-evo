...
snakemake <- Snakemake(
    ...
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'disk_mb', 'tmpdir', 'log_loc', 'mfree', 'cluster_time', 'disk_free', 'runtime', 'n_cores', "mem_mb" = '3G', "disk_mb" = '4G', "tmpdir" = '/tmp/12724627.1.feder-short.q', "log_loc" = './log_scr/', "mfree" = '3G', "cluster_time" = '0:00:10:00', "disk_free" = '4G', "runtime" = 10, "n_cores" = '1'),
    config = list(),
    rule = 'gen_fig6',
...
ggsave(paste0(filepath, "res/fig6/fig6.png"), fig6, h = 22*(2/3), w = 18, unit = "cm", bg = "transparent", dpi = 300)
ggsave(paste0(filepath, "res/fig6/fig6.pdf"), fig6, h = 22*(2/3), w = 18, unit = "cm", bg = "transparent", dpi = 300)
ggsave(paste0(filepath, "res/fig6/fig6.svg"), fig6, h = 22*(2/3), w = 18, unit = "cm", bg = "transparent", dpi = 300, device = "svg")
