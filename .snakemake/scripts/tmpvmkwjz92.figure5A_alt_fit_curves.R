...
snakemake <- Snakemake(
    ...
    output = list('runs/ddt_logistic_mu_2e-05_2025-03-24/res/fig5/A.rds'),
    params = list('2025-03-24', c('logistic'), c(2e-05), "date" = '2025-03-24', "fit_func" = c('logistic'), "mu" = c(2e-05)),
    wildcards = list(),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'disk_mb', 'tmpdir', 'log_loc', 'mfree', 'cluster_time', 'disk_free', 'runtime', 'n_cores', "mem_mb" = '3G', "disk_mb" = '4G', "tmpdir" = '/tmp/12724631.1.feder-short.q', "log_loc" = './log_scr/', "mfree" = '3G', "cluster_time" = '0:00:10:00', "disk_free" = '4G', "runtime" = 10, "n_cores" = '1'),
    config = list(),
    rule = 'fig5A',
...
func_plot <- ggplot() +
  ...
  theme(
    ...
    legend.position.inside = c(0.15, 0.94), ## Upper left
...
ggsave(paste0(filepath, "res/fig5/A.png"), func_plot, h = 22/3, w = 18/2, unit = "cm", bg = "transparent", dpi = 300)
ggsave(paste0(filepath, "res/fig5/A.pdf"), func_plot, h = 22/3, w = 18/2, unit = "cm", bg = "transparent", dpi = 300)
ggsave(paste0(filepath, "res/fig5/A.svg"), func_plot, h = 22/3, w = 18/2, unit = "cm", bg = "transparent", dpi = 300)
saveRDS(func_plot, file = paste0(filepath, "res/fig5/A.rds"))
