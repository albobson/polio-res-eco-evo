...
snakemake <- Snakemake(
    ...
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'disk_mb', 'tmpdir', 'log_loc', 'mfree', 'cluster_time', 'disk_free', 'runtime', 'n_cores', "mem_mb" = '3G', "disk_mb" = '4G', "tmpdir" = '/tmp/12722188.1.feder-short.q', "log_loc" = './log_scr/', "mfree" = '3G', "cluster_time" = '0:00:10:00', "disk_free" = '4G', "runtime" = 10, "n_cores" = '1'),
    config = list(),
    rule = 'fig2A',
...
ggsave(paste0(filepath,"res/fig2/A.png"), full_tan_trunc, h = 3.5, w = 3.5, units = "in", bg = "transparent", dpi = 300)
ggsave(paste0(filepath,"res/fig2/A.pdf"), full_tan_trunc, h = 3.5, w = 3.5, units = "in", bg = "transparent", dpi = 300)
ggsave(paste0(filepath,"res/fig2/A.svg"), full_tan_trunc, h = 3.5, w = 3.5, units = "in", bg = "transparent", device = 'svg')
