...
snakemake --cluster "qsub -cwd -o {resources.log_loc} -e {resources.log_loc} -l mfree={resources.mfree} -l disk_free={resources.disk_free} -l h_rt={resources.cluster_time} -pe serial {resources.n_cores}" --jobs 2