...
ggsave(paste0(filepath,"res/fig3/D.png"), full_my, h = height/2, w = width/2, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath,"res/fig3/D.pdf"), full_my, h = height/2, w = width/2, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath,"res/fig3/D.svg"), full_my, h = height/2, w = width/2, units = "cm", bg = "transparent", dpi = 1200, device = 'svg')
