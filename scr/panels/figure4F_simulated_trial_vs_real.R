...
## Save
ggsave(tend_plot, file = paste0(filepath, "res/fig4/F.png"), h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(tend_plot, file = paste0(filepath, "res/fig4/F.pdf"), h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(tend_plot, file = paste0(filepath, "res/fig4/F.svg"), h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200, device = 'svg')
