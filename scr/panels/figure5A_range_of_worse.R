...
func_plot <- ggplot() +
  ...
  theme(
    ...
    legend.position.inside = c(0.745, 0.186), ## bottom right
...
ggsave(paste0(filepath, "res/fig5/A.svg"), func_plot, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200, device = 'svg')
