...
plot6c <- ggplot(sims_id, aes(x = fold_strin, 
                              # group = wt_rep_abil,
...
ggsave(paste0(filepath, "res/fig5/C.png"), plot6c, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/fig5/C.pdf"), plot6c, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/fig5/C.svg"), plot6c, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200, device = 'svg')
saveRDS(plot6c, file = paste0(filepath, "res/fig5/C.rds"))
...
plot6d <- ggplot(sims_id, aes(x = fold_strin, 
                              # group = wt_rep_abil,
                              # fill=factor(log(wt_rep_abil))
)) +
  # geom_boxplot(notch=FALSE, outlier.shape=NA,
  ...
  theme(
    ...
    # legend.position = "inside",
    # legend.position.inside = c(0.35, 0.94), ## Upper left
    legend.position = c(0.86, 0.24), ## bottom right
...
ggsave(paste0(filepath, "res/fig5/D.png"), plot6d, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/fig5/D.pdf"), plot6d, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/fig5/D.svg"), plot6d, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200, device = 'svg')
saveRDS(plot6d, file = paste0(filepath, "res/fig5/D.rds"))
