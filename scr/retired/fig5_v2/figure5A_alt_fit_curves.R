...
func_plot <- ggplot() +
  ...
  theme(
    ...
    # legend.position.inside = c(0.27, 0.19), ## Upper left
...
ggsave(paste0(filepath, "res/fig5/A.png"), func_plot, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/fig5/A.pdf"), func_plot, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/fig5/A.svg"), func_plot, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
