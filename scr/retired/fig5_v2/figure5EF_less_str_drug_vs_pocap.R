...
ggsave(paste0(filepath, "res/fig5/E.png"), plot6e, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/fig5/E.pdf"), plot6e, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/fig5/E.svg"), plot6e, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200, device = 'svg')
saveRDS(plot6e, file = paste0(filepath, "res/fig5/E.rds"))
...
plot6f <- ggplot(sims_id, aes(x = fold_strin, 
  ...
  theme(
    ...
    # legend.position = "inside",
    # legend.position.inside = c(0.35, 0.94), ## Upper left
    legend.position = c(0.85, 0.23), ## bottom right
...
ggsave(paste0(filepath, "res/fig5/F.png"), plot6f, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/fig5/F.pdf"), plot6f, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/fig5/F.svg"), plot6f, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200, device = 'svg')
saveRDS(plot6f, file = paste0(filepath, "res/fig5/F.rds"))
