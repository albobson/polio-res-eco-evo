...
print(paste0("min_scale: ", min_scale, ", max_scale: ", max_scale))

scale_range <- 10^seq(from = log10(min_scale), to = log10(max_scale), length.out = 5)
...
ggsave(paste0(filepath, "res/sup/sfig6/A.png"), func_plot, h = height, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/sup/sfig6/A.pdf"), func_plot, h = height, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/sup/sfig6/A.svg"), func_plot, h = height, w = width/3, units = "cm", bg = "transparent", dpi = 1200, device = 'svg')
saveRDS(func_plot, file = paste0(filepath, "res/sup/sfig6/A.rds"))
