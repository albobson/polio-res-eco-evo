...
## Grab the .rds files
## Create the filepath where things will be saved
rds_files <- list.files(path = paste0(filepath, "res/sup/sfig5"), pattern = "\\.rds$", 
...
top_row <- plot_grid(sfig5a, sfig5b, sfig5c,
...
## All together
sfig5 <- plot_grid(top_row, mid_row,
                  nrow = 2, 
                  axis = "l", 
                  align = "v"
)
...
save_plot(paste0(filepath, "res/sup/sfig5/sfig5.png"), sfig5, base_height = height, base_width = width, unit = "cm", bg = "transparent", dpi = 1200)
save_plot(paste0(filepath, "res/sup/sfig5/sfig5.pdf"), sfig5, base_height = height, base_width = width, unit = "cm", bg = "transparent", dpi = 1200)
