...
scale_range <- seq(min_scale, max_scale, length.out = 5)
...
ggsave(paste0(filepath, "res/sup/sfig5/D.png"), func_plot, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/sup/sfig5/D.pdf"), func_plot, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/sup/sfig5/D.svg"), func_plot, h = height/2, w = width/3, units = "cm", bg = "transparent", dpi = 1200, device = 'svg')
saveRDS(func_plot, file = paste0(filepath, "res/sup/sfig5/D.rds"))
