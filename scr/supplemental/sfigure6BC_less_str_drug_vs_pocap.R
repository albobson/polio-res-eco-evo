...
## Read in trial data
trial_sims <- read.csv(paste0(filepath, "dat_gen/sims/all_full_stringency_trials.csv"))
...
sims_id <- sims %>%
  group_by(wt_rep_abil, id, c_pop, fold_strin) %>%
...
sims_stats_all <- sims_id %>%
  ungroup() %>%
  group_by(wt_rep_abil, fold_strin) %>%
...
splot6b <- ggplot(sims_id, aes(x = fold_strin, 
                              # group = wt_rep_abil,
...
ggsave(paste0(filepath, "res/sup/sfig6/B.png"), splot6b, h = height, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/sup/sfig6/B.pdf"), splot6b, h = height, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/sup/sfig6/B.svg"), splot6b, h = height, w = width/3, units = "cm", bg = "transparent", dpi = 1200, device = 'svg')
saveRDS(splot6b, file = paste0(filepath, "res/sup/sfig6/B.rds"))
...
splot6c <- ggplot(sims_id, aes(x = fold_strin, 
                              # group = wt_rep_abil,
                              # fill=factor(log(wt_rep_abil))
)) +
  # geom_boxplot(notch=FALSE, outlier.shape=NA,
...
ggsave(paste0(filepath, "res/sup/sfig6/C.png"), splot6c, h = height, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/sup/sfig6/C.pdf"), splot6c, h = height, w = width/3, units = "cm", bg = "transparent", dpi = 1200)
ggsave(paste0(filepath, "res/sup/sfig6/C.svg"), splot6c, h = height, w = width/3, units = "cm", bg = "transparent", dpi = 1200, device = 'svg')
saveRDS(splot6c, file = paste0(filepath, "res/sup/sfig6/C.rds"))
...
# 
# 
# ggsave(plot6d, file = paste0(filepath, "res/fig5/D.png"), h = 8, w = 8, bg = "transparent")
# ggsave(plot6d, file = paste0(filepath, "res/fig5/D.jpg"), h = 8, w = 8, bg = "transparent")
# ggsave(plot6d, file = paste0(filepath, "res/fig5/D.svg"), h = 8, w = 8, bg = "transparent", device = 'svg')
# saveRDS(plot6d, paste0(filepath, "res/fig5/D.rds"))